...
4. My issue during this iteration was making sure the save/load feature was ready for the final submission. I checked the SQLite driver setup and reviewed the persistence files so the save/load system could run correctly. - Ryan Nguyen
