...
3. My biggest issue this week was trying to use PropertyChangeListener and redo all the code to use it. I also struggled with tryint to get the view and the control to communicate properly through the PropertyChangeListener and had to spend several hours researhing PropertyChangeListener to figure out how to properly set it all up. - Devin Riel 
